...
const MobileSidebarContent = () => {
  ...
  return (
    <Sheet>
      ...
      >
        <div>
          <Link href="" className="sticky dark:bg-neutral-900 bg-white z-[40] top-0 mb-8 w-full">
            <div
